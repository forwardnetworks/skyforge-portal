...
export function TopologyViewer({
	...
	}, [deploymentId, statsEnabled, userId]);
	...
	return (
		...
		>
			...
			{enableTerminal && userId && deploymentId ? (
				<TerminalModal
					open={!!terminalNode}
					onOpenChange={(open) => {
