...
function InfobloxConsolePage() {
	...
	const statusQ = useQuery({
		queryKey: ["infobloxStatus", "integrationsConsole"],
	...
	if (statusQ.isLoading) {
		return <div className="p-6 text-sm text-muted-foreground">Checking Infoblox VM status…</div>;
	}
			...
			<div className="p-6">
				<Card>
					<CardHeader>
						<CardTitle>Infoblox Console</CardTitle>
						<CardDescription>
							Failed to load Infoblox status. This usually means the VM is missing or not managed.
						</CardDescription>
					</CardHeader>
