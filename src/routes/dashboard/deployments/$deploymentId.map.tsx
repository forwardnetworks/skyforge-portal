...
export const Route = createFileRoute("/dashboard/deployments/$deploymentId/map")({
      ...
      <div className="flex items-center justify-between gap-3 border-b px-4 py-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="text-xs text-muted-foreground font-mono truncate">{deployment.id}</div>
          </div>
        </div>
