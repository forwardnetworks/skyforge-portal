...
export function useForwardAnalyticsPage({ userId }: { userId?: string }) {
	...
	const networks = useMemo(
		() => (networksQ.data?.networks ?? []) as ForwardAnalyticsNetwork[],
	...
	const createM = useMutation({
		mutationFn: async () => {
			...
			return createUserScopeForwardNetwork(scopeId, {
				name: trimmedName,
				forwardNetwork: trimmedForwardNetworkId,
...
export type ForwardAnalyticsPageData = ReturnType<typeof useForwardAnalyticsPage>;
