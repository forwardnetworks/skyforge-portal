...
export async function listUserForwardCollectorConfigs(): Promise<ListUserForwardCollectorConfigsResponse> {
  return apiFetch<ListUserForwardCollectorConfigsResponse>("/api/forward/collector-configs");
}
...
export async function createUserForwardCollectorConfig(
  ...
  return apiFetch<UserForwardCollectorConfigSummary>("/api/forward/collector-configs", {
    method: "POST",
    body: JSON.stringify(body),
  });
}

export async function deleteUserForwardCollectorConfig(id: string): Promise<DeleteUserForwardCollectorConfigResponse> {
  return apiFetch<DeleteUserForwardCollectorConfigResponse>(`/api/forward/collector-configs/${encodeURIComponent(id)}`, {
    method: "DELETE",
  });
}

export async function getUserForwardCollectorConfigRuntime(id: string): Promise<CollectorRuntimeStatus> {
  return apiFetch<CollectorRuntimeStatus>(`/api/forward/collector-configs/${encodeURIComponent(id)}/runtime`);
}
...
export async function getUserForwardCollectorConfigLogs(id: string, tail?: number): Promise<UserCollectorConfigLogsResponse> {
  const qs = new URLSearchParams();
...
export async function restartUserForwardCollectorConfig(id: string): Promise<CollectorRuntimeStatus> {
  return apiFetch<CollectorRuntimeStatus>(`/api/forward/collector-configs/${encodeURIComponent(id)}/restart`, {
    method: "POST",
    body: "{}",
  });
}
