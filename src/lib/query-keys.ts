export const queryKeys = {
	...
	forwardNetworkCostInsights: (userId: string, networkRef: string) =>
		["forwardNetworkCostInsights", userId, networkRef] as const,
	...
	adminTaskQueueDiag: () => ["adminTaskQueueDiag"] as const,
